...
/* harmony import */ var _modules_feed_feed_model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/feed/feed-model */ "./src/modules/feed/feed-model.js");
...
class API {
  ...
  getData() {
    return this._load({
      url: `kindle`
    }).then(toJSON).then(_modules_feed_feed_model__WEBPACK_IMPORTED_MODULE_0__["default"].parseFeedItems);
  }
  ...
  _load({
    ...
    return fetch(`${this._endPoint}/${url}.json?limit=${this._itemsCount}&${this._liveTime}`, {
      method,
      body,
      headers
...
/* harmony import */ var _modules_feed_feed_card__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/feed/feed-card */ "./src/modules/feed/feed-card.js");
...
const renderFeed = feed => {
  ...
  for (const feedCard of feed) {
    const taskComponent = new _modules_feed_feed_card__WEBPACK_IMPORTED_MODULE_1__["default"](feedCard);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _helpers_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../helpers/component */ "./src/helpers/component.js");
    ...
    return `
      <article class="feed-card" id="${this._id}">
        ...
        <footer class="feed-card__footer">
          <time datetime="${moment__WEBPACK_IMPORTED_MODULE_1___default()(this._date).format(`YYYY-MM-DD`)}">
            ${moment__WEBPACK_IMPORTED_MODULE_1___default()(this._date).format(`DD/MM/YYYY HH:MM`)}
          </time>
        </footer>
      </article>`.trim();
  }
...
/* harmony default export */ __webpack_exports__["default"] = (FeedCard);
...
/* harmony default export */ __webpack_exports__["default"] = (FeedModel);
